    ...
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<bool> SendHotelRegisterRequest(HotelOwnerRegisterViewModel hotel)
        {
            ...
            try
            {
                ...
                // Create hotel registration request
                var newRequest = new HotelRegistrationRequest
                {
                    ...
                    Email = hotel.Email,
                    Password = hotel.Password,  // ✅ Password is saved
            ...
            {
                // Rollback: Delete any saved files if database save fails
